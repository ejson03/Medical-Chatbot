	...
	function setBotResponse(val) {
		...
		setTimeout(async function () {
			...
			if ($.trim(val) == '' || val == 'error') { //if there is no response from bot or there is some error
				...
				var BotResponse = '<div class="d-flex justify-content-start mb-4"><div class="img_cont_msg"><img src="https://static.turbosquid.com/Preview/001292/481/WV/_D.jpg" class="rounded-circle user_img_msg"></div><div class="msg_cotainer">' + val+'<span class="msg_time">'+ time + '</span></div></div>';//<div class="clearfix"></div>;
				...
				for (var i = 0; i < val.length; i++) {
					if (val[i].hasOwnProperty("image")) { //check if there are any images
						msg += '<div class="d-flex justify-content-start mb-4"><div class="img_cont_msg"><img src="https://static.turbosquid.com/Preview/001292/481/WV/_D.jpg" class="rounded-circle user_img_msg"></div>'+'<img  width="240" height="240" src=\"data:image/png;base64,' + val[i].image +'\">'+ '<span class="msg_time">'+ time + '</span></div>';//<div class="clearfix"></div>;
						...
						msg +='<div class="d-flex justify-content-start mb-4"><div class="img_cont_msg"><img src="https://static.turbosquid.com/Preview/001292/481/WV/_D.jpg" class="rounded-circle user_img_msg"></div><div class="msg_cotainer">' + val[i].text+'<span class="msg_time">'+ time + '</span></div></div>';//<div class="clearfix"></div>;
